...
assumptions: 1. the risk of influenza infection is 28% in each year of life 2. the frequency of each circulating subtype could be inferred from the numbers of isolates sampled (primarily in hospitals) each year
